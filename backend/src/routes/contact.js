...
const { validateContactForm, sanitizeContactData } = require('../middleware/validation');
...
router.post('/', contactLimiter, validateContactForm, sanitizeContactData, async (req, res) => {
  try {
    ...
    if (emailResult.success) {
      ...
      res.status(500).json({
        success: false,
        message: 'Failed to send your message. Please try again or contact us directly at hello@bruv.co.ke',
