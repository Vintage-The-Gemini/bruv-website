        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center lg:text-left mb-16 lg:mb-0">
            ...
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-12 max-w-2xl mx-auto lg:mx-0">
              Empowering project managers, internal auditors, and compliance heads with 
              intelligent solutions that strengthen organizational controls.
            </p>
          ...
          <div className="relative">
            <div className={`${
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className={`${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'} rounded-xl p-4 text-center backdrop-blur-sm`}>
                  <p className="text-3xl font-bold text-red-500 mb-1">24</p>
                  <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                    Active Projects
                  </p>
                </div>
                <div className={`${isDarkMode ? 'bg-gray-700/50' : 'bg-gray-50'} rounded-xl p-4 text-center backdrop-blur-sm`}>
                  <p className="text-3xl font-bold text-green-500 mb-1">98%</p>
                  <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                    Compliance
                  </p>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between text-sm mb-3">
                    <span className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>Risk Assessment</span>
                  ...
                  <div className={`w-full ${isDarkMode ? 'bg-gray-600' : 'bg-gray-200'} rounded-full h-3`}>
                    <div className="bg-red-500 h-3 rounded-full transition-all duration-1000 shadow-lg" style={{width: '85%'}}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-3">
                    <span className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>Audit Progress</span>
                    <span className={isDarkMode ? 'text-gray-300' : 'text-gray-800'}>72%</span>
                  </div>
                  <div className={`w-full ${isDarkMode ? 'bg-gray-600' : 'bg-gray-200'} rounded-full h-3`}>
                    <div className="h-3 rounded-full transition-all duration-1000 shadow-lg" style={{width: '72%', backgroundColor: '#2D1B69'}}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-sm mb-3">
                    <span className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>Team Performance</span>
                    <span className={isDarkMode ? 'text-gray-300' : 'text-gray-800'}>92%</span>
                  </div>
                  <div className={`w-full ${isDarkMode ? 'bg-gray-600' : 'bg-gray-200'} rounded-full h-3`}>
                    <div className="bg-green-500 h-3 rounded-full transition-all duration-1000 shadow-lg" style={{width: '92%'}}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`absolute -top-4 -right-4 ${
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-xs font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Live</span>
              </div>
            </div>
          </div>
          </div>
      ...
      <section className={`py-16 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p className={`text-sm font-medium mb-8 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Trusted by world-class organizations
            </p>
            <div className="flex items-center justify-center space-x-12 lg:space-x-16 flex-wrap gap-8">
              <div className={`text-2xl lg:text-3xl font-bold ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} hover:text-red-500 transition-colors duration-300 cursor-pointer`}>
                Microsoft
              </div>
              <div className={`text-2xl lg:text-3xl font-bold ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} hover:text-red-500 transition-colors duration-300 cursor-pointer`}>
                Google
